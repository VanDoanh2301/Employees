...
//        Department P1 = createDepartmentIfNotFound(2,"PHONG PHONG 1", "P1");
//        Department P2 = createDepartmentIfNotFound(3,"PHONG PHONG 2", "P2");
//        Department P3 = createDepartmentIfNotFound(4,"PHONG PHONG 3", "P3");
//        Department P4 = createDepartmentIfNotFound(5,"PHONG PHONG 4", "P4");
//
